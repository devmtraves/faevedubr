...
<div class="menuAdm">
    <ul>
        <li><a href="cadastrardiploma.php" target="_self">Cadastrar Diploma</a></li>
...
<div class="conteudo">
    ...
    <p>Nesta seção, é possível registrar novos diplomas no sistema, informando dados como nome do aluno, curso, data de conclusão e número de registro.</p>
       <h2>📜 Cadastrar Certificados de Conclusão de Curso de Extensaões e Pós Graduação</h2>
        <p>Nesta seção, é possível registrar novos certificados no sistema, informando dados como nome do aluno, curso, data
            de conclusão .</p>
